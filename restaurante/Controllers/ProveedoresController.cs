...
{
    [Authorize(Roles = "administrador,personal,proveedor")]
    public class ProveedoresController : Controller
    {
        private readonly RestauranteWebContext _context;

        public ProveedoresController(RestauranteWebContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdProveedor,Nombre,Contacto,Telefono,Email")] Proveedore proveedore)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdProveedor,Nombre,Contacto,Telefono,Email")] Proveedore proveedore)
        {
